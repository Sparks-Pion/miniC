cd /home/$(whoami)/miniC/lab4/task403
...
diff -b tmp /home/$(whoami)/miniC/answers/lab4/task403/answer$1.txt #没什么用的操作
else
#cat tokens.txt											#显示程序运行结果
diff -b tokens.txt /home/$(whoami)/miniC/answers/lab4/task403/answer$1.txt
fi
fi